...
/**
 * Template data for Vived
 */
function suggester_vived_template() {
    return array(
        'name' => __('Vived', 'suggester'),
        'description' => __('Bright and vibrant theme with modern colors', 'suggester'),
        'colors' => array('#7733ff', '#ff3377', '#33aaff', '#ffcc00'),
        'config' => array(
            'primary_color' => '#ffffff',
            'secondary_color' => '#f9f7ff',
            'border_color' => '#e5e0ff',
            'accent_color' => '#7733ff',
...
/**
 * Render Vived Template HTML
 * 
 * @param array $settings Tool settings
 * @return string Template HTML
 */
function suggester_render_vived_template($settings) {
    // Extract settings with defaults
    $config = isset($settings['template_config']) ? $settings['template_config'] : array();
    
    // Set default values if not provided
    $accent_color = isset($config['accent_color']) ? $config['accent_color'] : '#7733ff';
    ...
    ob_start();
    ?>
    <div class="suggester-container suggester-vived" style="--accent-color: <?php echo esc_attr($accent_color); ?>; --button-text-color: <?php echo esc_attr($button_text_color); ?>;">
    ...
    <template id="suggester-vived-suggestion-template">
    ...
    <template id="suggester-vived-favorite-template">
