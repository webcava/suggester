...
(function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const suggesterContainers = document.querySelectorAll('.suggester-light');
    ...
    function initSuggester(container) {
        ...
        // Templates
        const suggestionTemplate = document.getElementById('suggester-light-suggestion-template');
        const favoriteTemplate = document.getElementById('suggester-light-favorite-template');
        ...
        function getContainerId(container) {
            ...
            if (!id) {
                const containers = document.querySelectorAll('.suggester-light');
